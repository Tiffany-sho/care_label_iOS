/**
 * 【診断】記号でない箱（生地・タグの文字）を構造で見分けられるかを測る。
 *
 * lib/vision/reader.ts の MIN_BODY_INK_SHARE（0.3）を決めた道具。
 * 2026-08-21 時点: 文字の箱は落とせるが、生地の織り目の箱は落とせない
 * （最大成分の取り分 0.834 で、記号と同じ性質を持つ）。
 */
